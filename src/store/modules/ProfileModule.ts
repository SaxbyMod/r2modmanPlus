...
export default {
    ...
    actions: <ActionTree<State, RootState>>{
        ...
        async getModsWithUpdates({getters, rootState}): Promise<ThunderstoreCombo[]> {
            ...
            return await PackageDb.getCombosByDependencyStrings(community, outdated, useLatestVersion);
        },
